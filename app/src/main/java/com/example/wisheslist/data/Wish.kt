...
object DummyWish {
    val wishList = listOf(
        ...
        Wish(title = "Google Calender", description = "An android watch"),
        Wish(title = "Google Chair", description = "An android watch"),
        Wish(title = "Google Book", description = "An hard book"),
    )
}